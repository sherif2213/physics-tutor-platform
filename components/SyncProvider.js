...
import { getQueuedMutations, getMeta } from '@/lib/offlineDb';
          ...
          const refreshPending = async () => {
              const q = await getQueuedMutations();
                  setPendingCount(q.length);
                      const err = await getMeta('lastSyncError');
                                                                                              ...
                                                                                              <SyncContext.Provider value={{ online, pendingCount, runSync: handleManualSync }}>
                                                                                                    {children}
                                                                                                          {(!online || pendingCount > 0) && (
                                                                                                                  <div className="fixed bottom-4 inset-x-4 sm:inset-x-auto sm:left-4 z-50 flex flex-col gap-2 glass-card px-4 py-3 text-sm max-w-md">
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        {online && pendingCount > 0 && (
                                                                                                                                                                                                                                                                                                                      <button onClick={handleManualSync} className="text-amber-400 font-bold shrink-0">
                                                                                                                                                                                                                                                                                                                                      مزامنة الآن
                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                    {online && lastError && (
                                                                                                                                                                                                                                                                                                                                                                                                <p className="text-red-400 text-xs break-words">خطأ: {lastError}</p>
                                                                                                                                                                                                                                                                                                                                                                                                          )}
                                                                                                                                                                                                                                                                                                                                                                                                                  </div>
                                                                                                                                                                                                                                                                                                                                                                                                                        )}
